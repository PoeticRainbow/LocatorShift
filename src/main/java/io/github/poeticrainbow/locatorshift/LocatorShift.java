...
public class LocatorShift implements ModInitializer, ClientModInitializer {
    ...
    public static final KeyMapping TOGGLE_LOCATOR_BAR = KeyMappingHelper.registerKeyMapping(
        new KeyMapping(
    ...
    public void onInitializeClient() {
        ...
        HudElementRegistry.attachElementBefore(VanillaHudElements.BOSS_BAR, of("locator_bar"), locatorBar::extractBackground);
        // Addons render in front of the Boss Bar and Text
        HudElementRegistry.attachElementAfter(VanillaHudElements.BOSS_BAR, of("locator_bar_addons"), locatorBar::extractRenderState);
        ...
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            ...
            if (TOGGLE_LOCATOR_BAR.consumeClick()) {
                ...
                client.player.sendOverlayMessage(Component.translatable(LocatorShiftConfig.locatorBarVisible ?
                    "message.locatorshift.toggle_on" : "message.locatorshift.toggle_off"));
            }
        });
    }
